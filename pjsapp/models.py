...
class Project(models.Model):
    id=models.AutoField(primary_key=True)
    category_choices = (("Strategic projects", "Strategic projects"), ("Operational projects", "Operational projects"), ("Compliance projects", "Compliance projects"), ("Small scale projects","Small scale projects"),("Others","Others"))
